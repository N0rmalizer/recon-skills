...
| **L6 — Monitoring** | Full I/O logging, behavioral anomaly detection,command line-call circuit breakers | Novel/zero-day injection patterns |
...
## Verification
1. **Prompt injection probe** — confirm basic tooling:
