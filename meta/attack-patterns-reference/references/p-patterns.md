...
**Real Confirmation:** staging.[RETAIL_CHAIN] — 15 IMDS paths all returned faultCode 0 in Wave6.
...
**Confirmed on:** staging.[RETAIL_CHAIN] (Wave8).
...
**Confirmed on:** [WINE_STORE] — 1.7MB error_log with 47 server paths, 879 SQL queries.
...
**Confirmed on:** [WINE_STORE] — ALL exec functions available (exec, system, passthru, shell_exec, popen, proc_open).
...
**Confirmed on:** [MATTRESS_RETAILER] — CORS credential reflection on ALL 7 tested endpoints.
