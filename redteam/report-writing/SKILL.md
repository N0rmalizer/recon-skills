...
### Data Hygiene in Skills & Public Documentation

Skills, README files, and any public-facing documentation must be **fully agnostic**. Never include:

- Company names, domains, or brand names
- Employee names, emails, or personal identifiers
- Specific vulnerability details tied to identifiable targets
- Project IDs, bucket names, or internal hostnames
...
- Use sector-level descriptions (e.g., "healthcare SaaS," "e-commerce," "government portal")
- Aggregate statistics (e.g., "~7-8% of WP sites have CORS") rather than per-target specifics
- If a real-world example is essential, strip all identifying details: replace domain with sector, remove emails, anonymize project IDs
