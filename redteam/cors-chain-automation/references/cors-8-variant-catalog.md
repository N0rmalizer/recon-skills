...
**Examples:** landscaping-service.com, [MATTRESS_RETAILER], [WINE_STORE], [REAL_ESTATE], [ENTERTAINMENT], [RETAILER], legal-firm.com, photography-platform.com, glass-repair.com, hvac-service.com, megachurch-site.com, septic-service.com, moving-service.com, auto-body-shop.com
...
**Examples:** [MATTRESS_RETAILER] (gf/v2, solidwp-mail/v1), [RETAILER] (elementor/v1)
...
**Examples:** [ENTERTAINMENT] (gravity-pdf/v1)
...
- `/root/output/recon_output/techniques/wave9_techniques.md` — 25 pattern catalog including CORS variants
- `/root/output/recon_output/techniques/wave-analysis-20260624-1349.md` — Cross-wave intelligence report
